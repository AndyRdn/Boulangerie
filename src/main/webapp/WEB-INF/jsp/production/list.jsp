...
<%@ page import="org.main.boulangerie.production.Production" %>
<%
    List<Production> production = (List<Production>) request.getAttribute("prod");
